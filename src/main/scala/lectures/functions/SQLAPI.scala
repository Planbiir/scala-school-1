...
class SQLAPI(resource :String) {
  ...
  def execute(sql: String): String = ((connection compose logParameter[String] andThen openConnection) (resource) andThen logParameter[String] compose logParameter[String]) (sql)
